...
seajs.config({base:"/moe/",paths:{coding:"http://"+window.location.host+"/coding.net.demo/"},alias:{jquery:"jquery/1.11.2/jquery-debug.js"},preload:["jquery"]}),seajs.on("exec",function(e){e.uri===seajs.resolve("jquery")&&(window.$=window.jQuery=e.exports)}),seajs.use("jquery",function(e){window.jQuery=window.$=e});